...
class SpinningWheel(tk.Canvas):
    ...
    def draw_wheel_rotated(self, angle_offset):
        ...
        # Draw rotated arrow *as if it's part of the wheel*
...
class CharacterChallengeQuiz:
    ...
    def __init__(self, master, username, category):
        ...
        if USE_AI_QUESTIONS:
            ...
            def load_questions_async():
                ...
                if not new_questions:
                    ...
                    try:
                        ...
                        self.master.after(0, show_error_and_close)
                        return
            ...
            self.master.after(100, lambda: threading.Thread(target=load_questions_async).start())
            return
